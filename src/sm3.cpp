...
// static void prt_ctx(const sm3_context* pctx)
// {
//     char ss[1024];
//     int i;
//     for(i=0; i<2; i++)
//     {
//         printf("~~~~~~~~ pctx->total[%d] = %08X\n", i, pctx->total[i]);
//     }
//     for(i=0; i<8; i++)
//     {
//         printf("~~~~~~~~ pctx->state[%d] = %08X\n", i, pctx->state[i]);
//     }
//     bytes2hex_string((unsigned char*)ss, (unsigned char*)pctx->buffer, sizeof(pctx->buffer));
//     printf("~~~~~~~~ pctx->buffer[%d] = %s\n", strlen(ss), ss);
//     bytes2hex_string((unsigned char*)ss, (unsigned char*)pctx->ipad, sizeof(pctx->ipad));
//     printf("~~~~~~~~ pctx->ipad[%d] = %s\n", strlen(ss), ss);
//     bytes2hex_string((unsigned char*)ss, (unsigned char*)pctx->opad, sizeof(pctx->opad));
//     printf("~~~~~~~~ pctx->opad[%d] = %s\n", strlen(ss), ss);
// }
/*
           ...
           unsigned char output[32] )
{
	...
	// {
	// 	char ss[1024];
	// 	bytes2hex_string((unsigned char*)ss, (unsigned char*)input, ilen);
	// 	printf("----- - ---- input[%d] = %s\n", strlen(ss), ss);
	// 	bytes2hex_string((unsigned char*)ss, (unsigned char*)&ctx, sizeof(ctx));
	// 	printf("----- 1 ---- ctx[%d] = %s\n", strlen(ss), ss);
    //     prt_ctx(&ctx);
	// }
