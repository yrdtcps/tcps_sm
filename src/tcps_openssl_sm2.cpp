...
/**************************************************************************
* 函数名称： int Sm2Sign(const char *prikey,const unsigned char *digest,int digestlen,unsigned char *Sign,int *Signlen)  
* 功能描述： sm2 签名计算
* 访问的表： 
* 修改的表： 
* 输入参数： prikey        私钥指针
...
* 2019/05/24	     V1.0	    mwl	      
**************************************************************************/
int Sm2Sign(const char *prikey,const unsigned char *digest,int digestlen,unsigned char *Sign,int *Signlen)
{
	BN_CTX *ctx = NULL;
...
/**************************************************************************
* 函数名称： int Sm2Verify(const char *pubkeyX,const char *pubkeyY,const unsigned char *digest,int digestlen,const unsigned char *Sign,int Signlen) 
* 功能描述： sm2 签名验签
* 访问的表： 
* 修改的表： 
* 输入参数： pubkeyX       公钥x指针
...
* 2019/05/24	     V1.0	    mwl	      
**************************************************************************/
int Sm2Verify(const char *pubkeyX,const char *pubkeyY,const unsigned char *digest,int digestlen,const unsigned char *Sign,int Signlen)
{
	BN_CTX *ctx = NULL;
	BIGNUM *p = NULL;
	BIGNUM *a = NULL;
...
/**************************************************************************
* 函数名称： int Sm2Verify2(const char *pubkey,const unsigned char *digest,int digestlen,const unsigned char *Sign,int Signlen)
* 功能描述： sm2 签名验签
* 访问的表： 
* 修改的表： 
* 输入参数： pubkey       公钥指针
...
* 2019/05/24	     V1.0	    mwl	      
**************************************************************************/
int Sm2Verify2(const char *pubkey,const unsigned char *digest,int digestlen,const unsigned char *Sign,int Signlen)
{
	//BN_CTX *ctx = NULL;
	//BIGNUM *p = NULL;
	//BIGNUM *a = NULL;
	...
	else if(memcmp(pubkey,"04",2)==0)
	{
		...
		memcpy(keyX,pubkey+2,64);
		if (!BN_hex2bn(&x, keyX)) goto builtin_err;
...
/**************************************************************************
* 函数名称： int Sm2GetY(const char *pubkey,char *Y,int len)
* 功能描述： sm2 根据X计算Y
* 访问的表： 
* 修改的表： 
* 输入参数： *pubkey	--- 压缩公钥
...
* 2019/05/24	     V1.0	    mwl	      
**************************************************************************/
int Sm2GetY(const char *pubkey,char *Y,int len)
{
	BN_CTX *ctx = NULL;
	EC_GROUP *group= NULL;
